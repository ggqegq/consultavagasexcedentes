...
===== ESTILOS CSS =====
st.markdown("""
<style> .main-header { font-size: 2.5rem; font-weight: bold; color: #1e3a5f; text-align: center; margin-bottom: 1rem; } .sub-header { font-size: 1.2rem; color: #666; text-align: center; margin-bottom: 0.5rem; } .developer-name { font-weight: bold; color: #1e3a5f; } .metric-card { background-color: #f8f9fa; border-radius: 0.5rem; padding: 1rem; border-left: 4px solid #1e3a5f; margin-bottom: 1rem; } .stProgress > div > div > div > div { background-color: #1e3a5f; } </style>
...
def init(self, apenas_cursos_quimica=True):
